    ...
    return (
        <>
            ...
            <Box ref={parallaxRef} style={{
                ...
                <Image ref={hill1Ref} src={aboutHill1} alt="Hill 1"
                       style={{position: 'absolute', zIndex: 9, bottom: 20, left: '-5%', width: '110%'}}/>
                <Image ref={hill2Ref} src={aboutHill2} alt="Hill 2"
                       style={{position: 'absolute', zIndex: 9, bottom: -50, left: '15%', width: '110%'}}/>
                <Image ref={hill3Ref} src={aboutHill3} alt="Hill 3"
                       style={{position: 'absolute', zIndex: 11, bottom: 10, left: '-5%', width: '110%'}}/>
                <Image ref={hill4Ref} src={aboutHill4} alt="Hill 4"
                       style={{position: 'absolute', zIndex: 11, bottom: 0, left: '-5%', width: '110%'}}/>
                <Image ref={roadRef} src={aboutRoad} alt="Road"
                       style={{position: 'absolute', zIndex: 11, bottom: -140, left: '-5%', width: 'auto'}}/>
                <Box ref={contentRef} style={{
                    ...
                    zIndex: 10,
                    opacity: 0,
                    backgroundColor: 'rgba(0, 127, 127, 0.7)',
                    padding: '20px',
                    borderRadius: '10px',
                }}>
                    ...
                    <Text className="body_text" style={{color: 'white', maxWidth: '1000px', margin: '0 auto'}}>
                        VandyHacks is Vanderbilt's premiere hackathon, bringing together students from across the
                        country
                        for 36 hours of coding, learning, and innovation. Join us for workshops, networking, and the
                        chance
